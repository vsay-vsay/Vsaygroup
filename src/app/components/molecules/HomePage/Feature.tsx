...
import {Feature1,Feature2, Feature3, Feature4, Feature5, Feature6} from "@/app/images"

export function FeaturesSection() {
  const features = [
    {
      title: "Advanced Robotics & AI",
      description: "Cutting-edge robotics solutions with comprehensive training programs and expert product design.",
      skeleton: <SkeletonOne />,
      className: "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "IoT Ecosystems",
      description: "Revolutionary IoT solutions enabling smart device communication and business efficiency.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Digital Growth Hub",
      description: "Scalable tech solutions from cybersecurity to cloud deployment, optimized for success.",
      skeleton: <SkeletonThree />,
      className: "col-span-1 lg:col-span-3 lg:border-r dark:border-neutral-800",
    },
    {
      title: "Global Reach",
      description: "With our blazing fast cloud services, we deploy your models and products in seconds.",
    ...
    <div className="relative z-20 py-10 lg:py-24 max-w-7xl mx-auto">
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Empowering Possibilities: VSAY Tech Features
        </h4>
  ...
  return (
    <p
      className={cn(
        ...
        "text-left max-w-sm mx-0 md:text-sm my-2","Advanced Robotics & AI"
      )}
    >
      {children}
    </p>
