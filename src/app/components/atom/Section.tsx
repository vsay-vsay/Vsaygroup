// import SectionSvg from "../../images/footer/SectionSvg"
...
import SectionSvg from "@/app/images/footer/SectionSvg";
  ...
  return (
    ...
    >
      ...
      {crosses && (
        <>
          <div
            className={`hidden absolute top-0 left-7.5 right-7.5 h-0.25 bg-stroke-1 border mr-5 ml-5 ${crossesOffset || ''} pointer-events-none lg:block xl:left-10 right-10`}
          />
          <SectionSvg crossesOffset={crossesOffset} />
        </>
      )}
